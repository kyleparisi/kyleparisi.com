...
<div class="min-vh-100">
    ...
    <div class="w-90 w-75-m w-third-l center mt5">
        ...
        <div class="pa4-ns">
            <h4 class="tc near-black fw1">Create an Account</h4>

            <div class="red pb2">{{ $errors->exists ?? "" }}</div>
            <form method="POST">
                <div class="pb3">
                    <div>
                        <label for="email" class="f6">Email</label>
                    </div>
                    <input title="email" name="email" autocomplete="username" type="email" value="{{ $email ?? "" }}"
                ...
                <div class="pb3">
                    ...
                    <input title="password" name="password" autocomplete="new-password" type="password"
                           class="input-reset ba b--black-10 pa2 bg-light-gray b0 w-100"/>
            ...
            <div class="fw1 pb4">By registering, you agree to our <a href="terms" class="link blue">terms and
                    conditions.</a></div>
        </div>

        <div class="br2 br--bottom b--black-05 pa4 bg-light-gray">
            Already have an account? <a href="login" class="link blue">Login</a>
        </div>
    </div>
